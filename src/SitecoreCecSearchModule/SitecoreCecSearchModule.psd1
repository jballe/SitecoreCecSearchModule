# Module manifest for module 'SitecoreCecSearchModule'
@{

    # Script module or binary module file associated with this manifest.
    RootModule           = 'SitecoreCecSearchModule.psm1'
    ...
    GUID                 = '144bcab6-95c3-4108-9b9d-2ae6a695265a'

    # Author of this module
    Author               = 'Jesper Balle'

    # Company or vendor of this module
    CompanyName          = 'Sitecore-contrib'

    # Copyright statement for this module
    Copyright            = '(c) Jesper Balle. All rights reserved. LGPL'

    # Description of the functionality provided by this module
    Description          = 'This module lets you interact with the APIs provided by the Sitecore Customer Engagement Console (CEC) for Sitecore Search.'
    ...
    'Update-CecConnectorVersion',
    'Set-CecConnectorCrawlerSchedule',
    'Add-CecSitemapQueryString',
    'Remove-CecSitemapQueryString',
    'Add-CecCrawlerHeader',
    'Remove-CecCrawlerHeader',
    'Add-CecConnectorVercelBypassProtection',
    'Remove-CecConnectorVercelBypassProtection',
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://www.github.com/jballe/SitecoreCecSearchModule'

            # A URL to an icon representing this module.
            IconUri    = 'https://raw.githubusercontent.com/jballe/SitecoreCecSearchModule/main/assets/icon.png'
